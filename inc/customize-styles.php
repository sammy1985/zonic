<?php
$top_bar_background_color = get_option('top_bar_background_color','#4172e0');
...
$shm_accent_color = get_option('shm_accent_color','#4172e0');
$header_bottom_border_color = get_option('header_bottom_border_color','#f7f7f7');
$header_link_color = get_option('header_link_color','#333333');
$header_link_hover_color = get_option('header_link_hover_color','#4172e0');
$submenu_link_color = get_option('submenu_link_color','#333333');
...
$mobile_hamburger_color = get_option('mobile_hamburger_color','#333333');
$mobile_menu_link_color = get_option('mobile_menu_link_color','#333333');

$fe_section_height = get_theme_mod('fe_section_height','350px');
$fe_content_position = get_theme_mod('fe_content_position','flex-end');

$content_text_color = get_option('content_text_color','#333333');
$content_link_color = get_option('content_link_color','#4172e0');
$content_title_color = get_option('content_title_color','#333333');

$button_background_color = get_option('button_background_color','#ffffff');
$button_background_hover_color = get_option('button_background_hover_color','#4172e0');
$button_text_color = get_option('button_text_color','#333333');
$button_text_hover_color = get_option('button_text_hover_color','#ffffff');
$button_border_color = get_option('button_border_color','#333333');
$button_border_hover_color = get_option('button_border_hover_color','#4172e0');

$shm_widget_background_color = get_option('shm_widget_background_color','#f7f7f7');
$shm_widget_text_color = get_option('shm_widget_text_color','#333333');
$shm_widget_link_color = get_option('shm_widget_link_color','#4172e0');
$shm_widget_link_hover_color = get_option('shm_widget_link_hover_color','#4172e0');

$footer_background = get_option('footer_background','#303e48');
$footer_text_color = get_option('footer_text_color','#ffffff');
$footer_link_color = get_option('footer_link_color','#4172e0');
$footer_link_hover_color = get_option('footer_link_hover_color','#4172e0');

$copyright_background = get_option('copyright_background','#242f37');
$copyright_text_color = get_option('copyright_text_color','#ffffff');
$copyright_link_color = get_option('copyright_link_color','#4172e0');
$copyright_link_hover_color = get_option('copyright_link_hover_color','#4172e0');
$footer_social_icon_color = get_option('footer_social_icon_color','#4172e0');
$social_icon_size = get_theme_mod('social_icon_size','20px');

?>
<style>
    body, button, input, select, textarea, p { font-family: <?php echo esc_html(get_theme_mod('custom_body_font_family')); ?>,sans-serif; font-size:<?php echo esc_html(get_theme_mod('shm_body_font_size')); ?>; }
    .container, .elementor-container { width: <?php echo esc_html($website_width); ?>;}
    h1, h2, h3, h4, h5, h6 { font-family: <?php echo esc_html(get_theme_mod('custom_title_font_family')); ?>, sans-serif}
